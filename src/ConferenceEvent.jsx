                    ...
                    avItems.map((item, index) => (
                      <div className="av_data venue_main" key={index}>
                        ...
                        <div className="addons_btn">
                          <button className={item.quantity === 0 ? "btn-warning btn-disabled" : "btn-minus btn-warning"} onClick={() => handleDecrementAvQuantity(index)}>
                            &ndash;
                          </button>

                          <span className="quantity-value">{item.quantity}</span>

                          <button className={item.quantity === 10 ? " btn-success btn-disabled" : "btn-success btn-plus"} onClick={() => handleIncrementAvQuantity(index)}>
                            &#43;
                          </button>
                        </div>
                      </div>
